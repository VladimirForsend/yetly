        ...
        <section className="mt-8 rounded-[28px] border border-slate-200 bg-white p-6 shadow-float sm:p-9">
            ...
            <div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl border border-brand-200 bg-brand-50 p-4">
                  ...
                  <p className="mt-1 text-sm leading-6 text-brand-800">Sigue estos pasos una sola vez, instala el SQL v1.9 y después invita al equipo mediante el enlace que genera Yetly.</p>
                </div>
          ...
          {step === 2 && (
            <div className="grid gap-8 lg:grid-cols-[.9fr_1.1fr]">
              <div>
                <p className="text-sm font-black uppercase tracking-wider text-brand-700">2. Instala Yetly v1.9 en tu base</p>
                <h1 className="mt-2 text-3xl font-black tracking-[-0.045em] text-ink-950">Copiar, pegar, ejecutar.</h1>
                <p className="mt-3 text-sm leading-6 text-ink-600">
                  El instalador actual corresponde al esquema interno 19. Crea o actualiza las tablas de Yetly, permisos RLS, edición y moderación de canales, migración reanudable, invitaciones, checklist, IA y Realtime.
                </p>
                ...
                <ol className="mt-6 space-y-4">
                  {[
                    ...
                    ["Pega todo el SQL v1.9", "Copia el bloque completo; no ejecutes fragmentos sueltos."],
              ...
              <div>
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="rounded-full bg-success-50 px-3 py-1 text-xs font-black text-success-700">Actual · v1.9 / esquema 19</span>
                </div>
                <textarea
                  id="yetly-schema-sql"
                  readOnly
